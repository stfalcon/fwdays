...
class Version20170718112640 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE static_page_translations (id INT AUTO_INCREMENT NOT NULL, object_id INT DEFAULT NULL, locale VARCHAR(8) NOT NULL, field VARCHAR(32) NOT NULL, content LONGTEXT DEFAULT NULL, INDEX IDX_F9058F2F232D562B (object_id), UNIQUE INDEX static_page_lookup_unique_idx (locale, object_id, field), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE static_page_translations ADD CONSTRAINT FK_F9058F2F232D562B FOREIGN KEY (object_id) REFERENCES pages (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE static_page_translations');
    }
}
