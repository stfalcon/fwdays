...
/**
 * Application\Bundle\DefaultBundle\Entity\Sponsor.
 *
 * @Vich\Uploadable
 *
 ...
 *
 * @Gedmo\TranslationEntity(class="Application\Bundle\DefaultBundle\Entity\Translation\SponsorTranslation")
 */
class Sponsor implements Translatable
{
    ...
    /**
     * @ORM\OneToMany(
     *   targetEntity="Application\Bundle\DefaultBundle\Entity\Translation\SponsorTranslation",
     *   mappedBy="object",
    ...
    /**
     * @ORM\OneToMany(targetEntity="Application\Bundle\DefaultBundle\Entity\EventSponsor",
