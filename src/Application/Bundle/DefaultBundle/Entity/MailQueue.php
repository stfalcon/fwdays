...
class MailQueue
{
     ...
     * @var User
     *
     * @ORM\ManyToOne(targetEntity="Application\Bundle\DefaultBundle\Entity\User", fetch="EXTRA_LAZY")
     ...
     * @var Mail
     *
     * @ORM\ManyToOne(targetEntity="Application\Bundle\DefaultBundle\Entity\Mail", inversedBy="mailQueues", cascade={"persist"}, fetch="EXTRA_LAZY")
