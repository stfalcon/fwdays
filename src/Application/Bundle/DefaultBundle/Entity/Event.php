...
class Event implements Translatable
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Application\Bundle\DefaultBundle\Entity\EventGroup", inversedBy="events", fetch="EXTRA_LAZY")
     */
    private $group;
     ...
     * @var ArrayCollection
     *
     * @ORM\ManyToMany(targetEntity="Application\Bundle\DefaultBundle\Entity\EventAudience", mappedBy="events", fetch="EXTRA_LAZY")
     */
    private $audiences;
