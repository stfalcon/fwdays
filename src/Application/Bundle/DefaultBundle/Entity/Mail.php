...
class Mail
{
     ...
     * @var EventAudience[]
     *
     * @ORM\ManyToMany(targetEntity="Application\Bundle\DefaultBundle\Entity\EventAudience", fetch="EXTRA_LAZY")
     ...
     * Add mailQueue.
     *
     * @param \Application\Bundle\DefaultBundle\Entity\MailQueue $mailQueue
     *
     * @return Mail
     */
