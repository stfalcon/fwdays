...
class LoadTicketData extends AbstractFixture implements DependentFixtureInterface
{
    ...
    {
        /**
         * @var \Application\Bundle\DefaultBundle\Entity\User
         * @var \Application\Bundle\DefaultBundle\Entity\User $userDefault2
         * @var \Application\Bundle\DefaultBundle\Entity\User $userDefault3
         * @var \Application\Bundle\DefaultBundle\Entity\User $userAdmin
         */
