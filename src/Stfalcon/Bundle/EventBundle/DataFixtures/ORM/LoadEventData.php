...
class LoadEventData extends AbstractFixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $event->setDate(new \DateTime('2018-04-19', new \DateTimeZone('Europe/Kiev')));
        ...
        $event->setAbout('Описание события');
        $event->setDate((new \DateTime('now', new \DateTimeZone('Europe/Kiev')))->add(new \DateInterval('P1M')));
        $event->setCost(100);
        $manager->persist($event);
        ...
        $event->setDate((new \DateTime('2017-10-02', new \DateTimeZone('Europe/Kiev')))->add(new \DateInterval('P1M')));
        $event->setReceivePayments(true);
        $event->setCost(100);
        $manager->persist($event);
        ...
        $event->setDate(new \DateTime('2018-03-02', new \DateTimeZone('Europe/Kiev')));
        $event->setReceivePayments(false);
        $event->setCost(100);
        $manager->persist($event);
