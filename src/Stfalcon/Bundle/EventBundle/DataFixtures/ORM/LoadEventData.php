...
class LoadEventData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $event->setLogo('/bundles/stfalconevent/images/zend-framework-day.png');
        $event->setCity('Киев');
        ...
        $event->setLogo('/bundles/stfalconevent/images/php-frameworks-day-2012.png');
        $event->setCity('Киев');
        ...
        $event->setLogo('/bundles/stfalconevent/images/smile-lol-icon.png');
