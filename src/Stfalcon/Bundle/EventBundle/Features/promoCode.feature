...
Функционал: Тест фунцыонала промо-кода
    ...
    Сценарий: Проверяем примененние действуещего промо-кода при оплате
        ...
        То я должен видеть "Promo code for ZFDays"
        То я должен видеть "100.00 грн"
        То я должен видеть "90 грн."
    ...
    Сценарий: Проверяем примененние действуещего промо-кода с нестандартной скидкой
        ...
        Если я нажимаю "Применить"
        То я должен видеть "Promo code for ZFDays 5%"
        То я должен видеть "100.00 грн"
        То я должен видеть "95 грн."
