...
#        Допустим я на странице "http://fwdays.work/event/zend-framework-day-2011"
...
#        И я должен видеть "Сумма к оплате: 100 грн."
    # проверка билета по номеру администратором
    Сценарий: Проверка билета по номеру администратором с валидным номером
        Допустим я вхожу в учетную запись с именем "admin@fwdays.com" и паролем "qwerty"
        Допустим я на странице "/check"
        Тогда код ответа сервера должен быть 200
        Тогда я должен видеть "Проверка билета по номеру"
        Тогда я должен видеть "Номер билета"
        Тогда я заполняю поле "form_id" значением "1"
        И я нажимаю "Проверить"
        Тогда код ответа сервера должен быть 200
        И я не должен видеть "Билет не найден"
        И я должен видеть 1 элемент "iframe"

    Сценарий: Проверка билета по номеру администратором с невалидным номером
        Допустим я вхожу в учетную запись с именем "admin@fwdays.com" и паролем "qwerty"
        Допустим я на странице "/check"
        Тогда код ответа сервера должен быть 200
        Тогда я должен видеть "Проверка билета по номеру"
        Тогда я должен видеть "Номер билета"
        Тогда я заполняю поле "form_id" значением "номер"
        И я нажимаю "Проверить"
        Тогда код ответа сервера должен быть 200
        И я должен видеть "Значение недопустимо"
        И я должен видеть 0 элементов "iframe"

    Сценарий: Проверка билета по номеру администратором с несуществующим номером
        Допустим я вхожу в учетную запись с именем "admin@fwdays.com" и паролем "qwerty"
        Допустим я на странице "/check"
        Тогда код ответа сервера должен быть 200
        Тогда я должен видеть "Проверка билета по номеру"
        Тогда я должен видеть "Номер билета"
        Тогда я заполняю поле "form_id" значением "11111"
        И я нажимаю "Проверить"
        Тогда код ответа сервера должен быть 200
        И я должен видеть "Билет не найден"
        И я должен видеть 0 элементов "iframe"

    # проверка билета по номеру волонтером
    Сценарий: Проверка билета по номеру волонтером с валидным номером
        Допустим я вхожу в учетную запись с именем "volunteer@fwdays.com" и паролем "qwerty"
        Допустим я на странице "/check"
        Тогда код ответа сервера должен быть 200
        Тогда я должен видеть "Проверка билета по номеру"
    ...
    Сценарий: Проверка билета по номеру волонтером с невалидным номером
        Допустим я вхожу в учетную запись с именем "volunteer@fwdays.com" и паролем "qwerty"
        Допустим я на странице "/check"
        Тогда код ответа сервера должен быть 200
        Тогда я должен видеть "Проверка билета по номеру"
    ...
    Сценарий: Проверка билета по номеру волонтером с несуществующим номером
        Допустим я вхожу в учетную запись с именем "volunteer@fwdays.com" и паролем "qwerty"
        Допустим я на странице "/check"
        Тогда код ответа сервера должен быть 200
        Тогда я должен видеть "Проверка билета по номеру"
